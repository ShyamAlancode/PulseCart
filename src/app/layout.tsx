          ...
          <footer className="border-t border-zinc-200 dark:border-white/5 py-8 mt-16 bg-zinc-100/40 dark:bg-black/40 transition-colors duration-300">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-sm text-zinc-500">
                © {new Date().getFullYear()} PulseCart. Built for H0 Hackathon.
              </div>
              <div className="text-xs text-zinc-500 dark:text-gray-600 flex items-center gap-2">
                <span>Backed by DynamoDB Transactions</span>
